...
import game.mastermind_engine as game

while True:
    game.number = game.create_number()
    print("Новое число загаданно!")
    code = ""
    while code != game.number:
        print("Введите свое число:")
        code = input()
        if(game.validate_input(code)):
            ret = game.check_input(code)
            print("Коров: ", ret['cows'], " Быков :", ret['bulls'])
        else:
            print("Число не должно начинаться с 0 и иметь повторяющие символы!")
